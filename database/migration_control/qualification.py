...
class MigrationQualificationService:
    ...
    def qualify(self, actual_target, environment_name):
        ...
        structural_plan=self.control_service.applied_structure_plan()
        drift=self.drift_inspector.inspect_expected(structural_plan) if status.applied_migrations else type('D',(),{'is_clean':True})()
