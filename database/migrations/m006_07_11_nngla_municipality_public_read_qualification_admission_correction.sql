...
-- P006.7.11.15.9 Sequence 30
-- MUNICIPALITY public-read qualification admission correction.
--
-- Governed feature qualification is authoritative for parent containment
-- and city positive-area conflict. Public-read admission must not rerun
-- those spatial qualification predicates after approved publication.
--
-- Label-point safety, qualification state, publication state and the
-- production execution receipt remain required.
