...
_MUNICIPALITY_GOVERNED_IDS_MATERIALIZATION_NAMESPACE = (
    "nngla.municipality.governed_ids.v1"
)
_MUNICIPALITY_RECORDS_MATERIALIZATION_NAMESPACE = (
    "nngla.municipality.public_map.records.v2"
)
