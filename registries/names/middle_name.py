...
class MiddleName:
    ...
    def as_canonical(self)->CanonicalName: return CanonicalName(self.name_id,self.canonical_value,NameKind.MIDDLE_NAME,self.metadata)
    ...
    @property
    def name_kind(self)->NameKind: return NameKind.MIDDLE_NAME
    @property
    ...
    @classmethod
    def from_dict(cls,data:Mapping[str,object])->"MiddleName":
        c=CanonicalName.from_dict(data)
        if c.name_kind is not NameKind.MIDDLE_NAME: raise ValueError("name_kind must be middle_name.")
