...
class FirstName:
    ...
    def as_canonical(self)->CanonicalName: return CanonicalName(self.name_id,self.canonical_value,NameKind.FIRST_NAME,self.metadata)
    ...
    @property
    def name_kind(self)->NameKind: return NameKind.FIRST_NAME
    @property
    ...
    @classmethod
    def from_dict(cls,data:Mapping[str,object])->"FirstName":
        c=CanonicalName.from_dict(data)
        if c.name_kind is not NameKind.FIRST_NAME: raise ValueError("name_kind must be first_name.")
