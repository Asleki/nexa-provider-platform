"""Credential-safe helpers for P006.7.11.15.8.1."""
...
from registries.nngla.city_containment_qualification.persistence import (
    PostgreSQLCityContainmentQualificationRepository,
)
from registries.nngla.city_containment_qualification.postgis import (
    PostGISCityContainmentQualificationEngine,
)
from registries.nngla.city_containment_qualification.service import (
    GovernedCityContainmentQualificationService,
)
...
def service(connection, *, environment_name: str, effective_date: str | None, revision: str | None = None):
    repository = PostgreSQLCityContainmentQualificationRepository(
        connection,
        environment_name=environment_name,
    )
    postgis = PostGISCityContainmentQualificationEngine(connection)
