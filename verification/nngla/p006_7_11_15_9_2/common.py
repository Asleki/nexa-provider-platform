"""Credential-safe helpers for sequence-29 incremental CITY_DISTRICT publication."""
...
from registries.nngla.city_district_realization.incremental import (
    IncrementalCityDistrictPublicationService,
)
...
def service(connection, *, environment_name: str, effective_date: str | None = None, revision: str | None = None):
    return IncrementalCityDistrictPublicationService(
        connection,
        source_path=SOURCE,
