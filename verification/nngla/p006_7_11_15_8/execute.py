#!/usr/bin/env python3
"""Explicit governed writer for one approved P006.7.11.15.8 CITY plan."""
...
def parser() -> argparse.ArgumentParser:
    ...
    value.add_argument("--effective-date", required=True, help="Exact effectiveDate from approved preview")
